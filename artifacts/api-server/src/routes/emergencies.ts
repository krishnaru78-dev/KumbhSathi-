...
router.get("/emergencies/contacts", (req, res) => {
  return res.json([
    ...
    { id: "4", name: "Kumbh Helpline", number: "1800-180-5000", type: "helpline", available24x7: true },
    ...
    { id: "7", name: "Disaster Mgmt", number: "1070", type: "helpline", available24x7: true },
  ]);
});
